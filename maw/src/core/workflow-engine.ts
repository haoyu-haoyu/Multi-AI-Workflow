    ...
    return {
      ...
      phases: [
        ...
        },
        {
          ...
          name: 'Synthesize',
          type: 'planning',
          capabilityId: 'synthesize.outputs',
          preferredProviders: ['claude'],
          assignedAI: 'claude',
    ...
    return {
      ...
      phases: [
        ...
        },
        {
          ...
          type: 'delegation',
          capabilityId: 'implement.frontend',
          preferredProviders: ['gemini'],
          assignedAI: 'gemini',
